import { createBook, destroyBook, getBook, listBooks, listBooksByAuthor, updateBook } from "@controllers/book";
...
routerBook.get("/book/:id/author",cache(env.CACHE,onlyStatus200),authorIdSchema, listBooksByAuthor );
routerBook.get("/book/:id",cache(env.CACHE,onlyStatus200),authorIdSchema, getBook);
routerBook.get("/book",cache(env.CACHE,onlyStatus200),listBooks);
